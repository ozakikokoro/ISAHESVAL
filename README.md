# ISAHESVAL-NL
## <INS>Is</INS>oform <INS>a</INS>nalysis of <INS>he</INS>terozygous putative <INS>s</INS>plicing <INS>v</INS>ariants at the <INS>a</INS>llele <INS>l</INS>evel using <INS>n</INS>anopore <INS>l</INS>ong-read sequencing
  
### Table of cotents  

What is ISAHESVAL-NL ?  
Tested environment  
Input requirement  
Citation  
...
# IMPORTANT: previous  
# input4=/your_file_dir/your_sample.hard-filtered_snpEff.ann.PASS_het.split.vcf.gz  
# might become an input in this step(5). Because the previous step (4) markedly reduce the variants (by up to 1/1000!),  
